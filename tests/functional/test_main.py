...
def test_home_page_fixture(test_client):
    '''
...
def test_home_page_post_fixture(test_client):
    '''
    GIVEN a app configured for testing
...
def test_about_page_fixture(test_client):
    '''
    GIVEN a app configured for testing
...
def test_about_page_post_fixture(test_client):
    '''
    GIVEN a app configured for testing
